...
```{r}
elephants<-read.csv("~/Desktop/BIS15L_W26_Mlastres/lab7/data/elephants.csv")
```
...
```{r}
#elephants %>% 
  #select(sex,estimated_age_years, years) %>% 
