...
```{r}
mammals<- read_csv("~/Desktop/BIS15L_W26_Mlastres/lab6/data/mammal_lifehistories_v2.csv")
```
...
```{r}
mammals %>% 
  mutate(across(c("order", "family", "genus"), tolower))#specific columns
```
...
```{r}
mammals %>% 
  mutate(mass_kg=mass/1000, wean_mass_kg=wean_mass/1000)
```
