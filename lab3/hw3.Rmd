...
```{r}
name<- c("everest", "k2","kangchenjunga","lhoste","makalu")
height<- c(29032,28251,28169,27940,27838)
height_meter<-c(8848.9,8611,8586,8516,8485)
```

**2. Combine these vectors into a data frame called `mountains`.**
```{r}
mountains<-tibble(name, height, height_meter)
mountains
```

**3. What is the mean height of the mountains in feet?**
```{r}
mean(mountains$height)
```
...
```{r}
mountains$summits<- c(12884,800,312, 900, 314 )
```
...
```{r}
mountains$fatalities<- c(344,100,50,20,20 )
```
...
```{r}
mountains$fatality_rate<- c(0.03, 0.13,0.16, 0.02, 0.06 )
```
